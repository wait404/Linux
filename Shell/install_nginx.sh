...
then
    apt-get update
    apt-get install curl gcc libpcre3 libpcre3-dev make openssl libssl-dev zlib1g zlib1g-dev -y
elif command -v yum &> /dev/null
then
    yum install curl gcc pcre pcre-devel make openssl openssl-devel zlib zlib-devel -y
else
